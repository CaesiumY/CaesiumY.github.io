...
전반적으로 시스템 프롬프트뿐 아니라 CLAUDE.md 파일과 스킬을 통해서도 Claude Code를 과도하게 제약해왔다는 점을 깨달았습니다.
...
![약 9,100자에 달하던 예전 TodoWrite 설명과, 상태 값만 간결하게 열거한 새 인터페이스 비교](./todowrite-comparison.png)
...
코드 형태로 Claude에게 레퍼런스를 줄 수도 있습니다. 스펙이 상세한 테스트 모음이거나, Claude가 이식할 만한 다른 코드베이스의 함수일 수도 있습니다.
