...
Claude Code를 활용한 AI-Native 개발 워크플로우를 지향하며, 비즈니스 목표를 위한 도구 사용을 아끼지 않습니다.
...
- **AI-Native 개발 환경 구축**: 다중 브랜드 확장 시 반복 개발 병목 발견 → Claude Code 마켓플레이스 플러그인(kotech-plugin) 제작, 기존 3주 소요 작업을 3일로 단축
