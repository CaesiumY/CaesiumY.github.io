...
```
스타일 가이드: .agents/skills/blog-writer/data/style-guide.md (수정)
피드백 로그: .agents/skills/blog-writer/data/feedback-log.md (추가)
승인 글 저장: .agents/skills/blog-writer/data/approved-posts/ (저장)
버전 히스토리: .agents/skills/blog-writer/data/style-history/ (백업)
```
...
cp .agents/skills/blog-writer/data/style-guide.md \
   .agents/skills/blog-writer/data/style-history/style-guide-YYYYMMDD-HHMMSS.md
```
...
```bash
# approved-posts/에 저장
cp [작성된글경로] .agents/skills/blog-writer/data/approved-posts/YYYYMMDD-[slug].md
```
...
**저장 경로**: `.agents/skills/blog-writer/data/approved-posts/[파일명]`
