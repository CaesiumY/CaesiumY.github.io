...
로그를 살펴보니 평가자가 구현을 스펙에 맞게 잡아주고 있다는 것이 분명했습니다. 로그를 살펴보니 평가자가 구현을 스펙에 맞게 잡아주고 있다는 것이 분명했습니다. 매 스프린트마다 계약의 테스트 기준을 점검하고 Playwright로 실행 중인 앱을 돌려보면서, 기대 동작에서 벗어나는 부분을 모두 버그로 기록했습니다. 계약은 세밀했습니다. 스프린트 3만 해도 레벨 에디터를 다루는 27개의 기준이 있었으며, 평가자의 발견 사항은 추가 조사 없이 바로 조치할 수 있을 만큼 구체적이었습니다. 아래는 평가자가 발견한 이슈 예시입니다.
