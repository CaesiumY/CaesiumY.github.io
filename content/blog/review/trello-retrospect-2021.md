...
처음에는 즐겨찾기로 구분했다. 그러다보니 어떤 게 본 거고, 어떤 게 안 본 건지 헷갈렸다. 이때쯤 컴퓨터 저 구석에 박혀있던 트렐로가 떠올랐다.~~(동아리 시절 잠깐 쓰고 말은)~~ 전에 학교 다닐 때 **다이어리로 정리했던 것들을 트렐로로 정리하기 시작**한 것이다.

# 기간

무려 **21개월 간이나 작성**해왔다. 기간이 무언가와 겹치지 않는가? 남자들이라면 알 바로 그 기간동안 주경야독으로 공부해온 흔적이다.
